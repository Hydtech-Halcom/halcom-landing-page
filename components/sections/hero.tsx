        ...
        >
          ...
          <motion.div className="flex flex-col gap-6" variants={fadeInUp}>
            <motion.div className="space-y-4" variants={itemVariants}>
              <motion.p className="text-primary font-semibold text-sm uppercase tracking-wider">
                Welcome to Halcom
              </motion.p>
              <motion.h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground leading-tight">
                Complete IT Infrastructure Solutions
              </motion.h1>
              <motion.p className="text-lg text-foreground-secondary leading-relaxed">
                Halcom is an IT Infrastructure Specialist determined to provide
                total solutions to our clients with 20+ years of experience and
          ...
          {/* Right Visual */}
          <motion.div
            className="relative h-96 sm:h-[500px] lg:h-full rounded-lg overflow-hidden"
          ...
          >
            ...
            >
              <motion.div
                className="text-center bg-white/95 backdrop-blur-sm rounded-2xl p-8"
                animate={{ y: [0, -10, 0] }}
