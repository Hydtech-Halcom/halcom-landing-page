...
const Logos3 = ({
  ...
  const secondLogos = [
    ...
    },
    {
      id: "second-logo-4",
      description: "Dahua",
      image: "/assets/partners/dahua-logo.png",
      className: "h-8 w-auto",
    },
    {
      id: "second-logo-5",
      description: "Panasonic",
      image: "/assets/partners/panasonic-logo.png",
      className: "h-8 w-auto",
    },
    {
      id: "second-logo-6",
      description: "Sony",
      image: "/assets/partners/sony-logo.png",
      className: "h-6 w-auto",
    },
    {
      id: "second-logo-7",
      description: "Mitsubishi",
      image: "/assets/partners/mitsubishi-logo.png",
      className: "h-8 w-auto",
    },
    {
      id: "second-logo-8",
      description: "LG",
      image: "/assets/partners/lg-logo.png",
      className: "h-8 w-auto",
    },
  ];
  return (
