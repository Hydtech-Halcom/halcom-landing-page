...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            // Warna lebih cerah + neon
            gradient.addColorStop(0, `hsla(${beam.hue}, 100%, 75%, 0)`);
            gradient.addColorStop(0.1, `hsla(${beam.hue}, 100%, 75%, ${pulsingOpacity * 0.7})`);
            ...
            gradient.addColorStop(0.9, `hsla(${beam.hue}, 100%, 75%, ${pulsingOpacity * 0.7})`);
            gradient.addColorStop(1, `hsla(${beam.hue}, 100%, 75%, 0)`);

            ctx.fillStyle = gradient;

            // Glow effect
            ctx.shadowColor = `hsla(${beam.hue}, 100%, 75%, ${pulsingOpacity})`;
            ctx.shadowBlur = beam.width * 2.5;
    ...
    return (
        ...
        >
            ...
            <div className={`relative z-10 flex  ${width == null ? "w-full" : width} ${height == null ? "h-screen" : height} items-center justify-center`}>
