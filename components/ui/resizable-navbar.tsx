...
export const MobileNavToggle = ({ isOpen, onClick }: { isOpen: boolean; onClick: () => void }) => {
  return isOpen ? <IconX className="text-black dark:text-white cursor-pointer" onClick={onClick} /> : <IconMenu2 className="text-black dark:text-white cursor-pointer" onClick={onClick} />;
};
