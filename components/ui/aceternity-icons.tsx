...
export const IconRocket = ({ className }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M4.5 16.5c-1.5-1.5-2-4-2-4s1-1 3-1 3.5.5 4.5 1.5c.5.5 1 1.5 1 3 0 .5.5 3.5-1 5.5-1.5 2-4 2-5 2-1 0-3 0-4-1"></path>
    <path d="M12 6v12m6-9a3 3 0 1 0 0 6"></path>
  </svg>
);
...
export const IconNetwork = ({ className }: IconProps) => (
  ...
  >
    ...
    <path d="M5.64 5.64a9 9 0 0 0 0 12.72m12.72 0a9 9 0 0 0 0-12.72M9 9a3 3 0 0 0 0 6m6 0a3 3 0 0 0 0-6"></path>
  </svg>
);
